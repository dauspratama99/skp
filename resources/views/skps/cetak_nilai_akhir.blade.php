...
<body style="padding: 10px;">
    <page size="A4" layout="lands">
        ...
        <table class="table table-bordered" style="border-style: solid; border:2px solid black; font-weight:bold;">
            ...
            <tr>
                <th style="width:1%; background-color:lightgray;"><b>NO</b></th>
                <th style="width:49%; background-color:lightgray;" colspan="6"><b>I. PEGAWAI NEGERI SIPIL YANG DINILAI</b></th>
            </tr>
            <tr>
                <td>1</td>
                <td colspan="3">Nama</td>
                <td colspan="3">{{$data->dinilai}}</td>
            </tr>
            <tr>
                <td></td>
                <td colspan="3">NIP</td>
                <td colspan="3">{{$data->nip_rated}}</td>
            </tr>
            <tr>
                <td></td>
                <td colspan="3">Pangkat/Gol. Ruang</td>
                <td colspan="3">{{$data->posisi_dinilai}} / {{$data->panggol_dinilai}}</td>
            </tr>
            <tr>
                <td></td>
                <td colspan="3">Jabatan</td>
                <td colspan="3">{{$data->unit_dinilai}}</td>
            </tr>
            <tr>
                <td></td>
            ...
            <tr>
                <th style="width:1%; background-color:lightgray;"><b>NO</b></th>
                <th style="width:49%; background-color:lightgray;" colspan="6"><b>II. PEJABAT PENILAI</b></th>
            </tr>
            <tr>
                <td>2</td>
                <td colspan="3">Nama</td>
            ...
            <tr>
                ...
                <td colspan="3">{{$data->unit_penilai}}</td>
                  ...
                  <tr>
                <th style="width:1%; background-color:lightgray;"><b>NO</b></th>
                <th style="width:49%; background-color:lightgray;" colspan="6"><b>III. ATASAN PEJABAT PENILAI</b></th>
            </tr>
            @foreach($atasan as $da)
            <tr>
                <td>3</td>
                <td colspan="3">Nama</td>
                <td colspan="3">{{$da->name}}</td>

            </tr>
            <tr>
                <td></td>
                <td colspan="3">NIP</td>
                <td colspan="3">{{$da->nip}}</td>
            ...
            @endforeach
              ...
              <tr>
                <th style="background-color: lightgray;"><b>NO</b></th>
                <th colspan="4" style="background-color: lightgray;"><b>UNSUR YANG DI NILAI</b></th>
                <th colspan="2" style="text-align: center; background-color: lightgray;"><b>JUMLAH</b></th>
            ...
            <tr>
                ...
                ?>
                    ...
                    <td style=" text-align:center; vertical-align:middle;" colspan="1">{{ round($total_b) }}</td>
            ...
            <tr>
                <td colspan="2" >9. Nilai Perilaku Kerja</td>
                <td colspan="2" >Total x 40% </td>

                <td style="text-align: center;" >{{round($hasil_total)}}</td>
            ...
            <tr>
                ...
                <td style=" text-align:center;">{{round($nil_skp)}} /
                    <?php
            ...
            <tr>
                ...
                <th style="width:1%; background-color:lightgray;"><b>NO</b></th>
                <th style="width:49%; background-color:lightgray;" colspan="6"><b>DETAIL PENILAIAN</b></th>
            </tr>
            <tr>
                <td rowspan="4">5</td>
                <td colspan="2" >Keberatan Dinilai</td>
                <td colspan="4" style="font-style: italic;"> {{$dt->objection_rated}}</td>
            </tr>
            <tr>
               
                <td colspan="3">Keberatan Penilai</td>
                <td colspan="3" style="font-style: italic;"> {{$dt->response_evaluator}}</td>
            </tr>
            <tr>
              
                <td colspan="3">Keputusan Atasan</td>
                <td colspan="3" style="font-style: italic;"> {{$dt->superior_decision}}</td>
            </tr>
            <tr>
                
                <td colspan="3">Rekomendasi</td>
                <td colspan="3" style="font-style: italic;"> {{$dt->recommendation}}</td>
            </tr>
            @endforeach
